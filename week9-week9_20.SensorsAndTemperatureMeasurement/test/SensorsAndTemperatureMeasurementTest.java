...
public class SensorsAndTemperatureMeasurementTest<_Sensor> {
    ...
    public void testConstantSensor() throws Throwable {
        ...
        assertEquals(k1, true, classRef.method(vs10, "isOn").returning(boolean.class).takingNoParams().withNiceError(k1).invoke());
        assertEquals(k2, true, classRef.method(vs55, "isOn").returning(boolean.class).takingNoParams().withNiceError(k1).invoke());
    ...
    public void testThermometer() throws Throwable {
        ...
        assertEquals(k1, false, classRef.method(meter1, "isOn").returning(boolean.class).takingNoParams().withNiceError(k1).invoke());
        ...
        assertEquals(k1, true, classRef.method(meter1, "isOn").returning(boolean.class).takingNoParams().withNiceError(k1).invoke());
        ...
        for (int i = 0; i < 1000; i++) {
            int tulos = classRef.method(meter1, "measure").returning(int.class).takingNoParams().withNiceError(k1).invoke();

...
public class MovingTest<_Thing, _Item, _Laatikko, _Packer> {
    ...
    public void itemCompareTo() throws Throwable {
        ...
        int x = _ItemRef.method(item, "compareTo").returning(int.class).taking(_ItemRef.cls()).invoke(item2);
        ...
        x = _ItemRef.method(item2, "compareTo").returning(int.class).taking(_ItemRef.cls()).invoke(item);
